...
Pod::Spec.new do |s|
  s.name             = 'NRControls'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NRControls.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/NRControls'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'naveenrana1309' => 'naveenrana1309@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/NRControls.git', :tag => s.version.to_s }
